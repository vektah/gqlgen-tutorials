...
type TodoResolver interface {
	UserRaw(ctx context.Context, obj *Todo) (*User, error)
	UserLoader(ctx context.Context, obj *Todo) (*User, error)
}
...
func (s shortMapper) Query_todos(ctx context.Context) ([]Todo, error) {
	return s.r.Query().Todos(ctx)
}

func (s shortMapper) Todo_userRaw(ctx context.Context, obj *Todo) (*User, error) {
	return s.r.Todo().UserRaw(ctx, obj)
}

func (s shortMapper) Todo_userLoader(ctx context.Context, obj *Todo) (*User, error) {
	return s.r.Todo().UserLoader(ctx, obj)
}
...
func (ec *executionContext) _Todo(ctx context.Context, sel []query.Selection, obj *Todo) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "userRaw":
			out.Values[i] = ec._Todo_userRaw(ctx, field, obj)
		case "userLoader":
			out.Values[i] = ec._Todo_userLoader(ctx, field, obj)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
func (ec *executionContext) _Todo_todo(ctx context.Context, field graphql.CollectedField, obj *Todo) graphql.Marshaler {
	rctx := graphql.GetResolverContext(ctx)
	rctx.Object = "Todo"
	rctx.Args = nil
	rctx.Field = field
...
func (ec *executionContext) _Todo_userRaw(ctx context.Context, field graphql.CollectedField, obj *Todo) graphql.Marshaler {
	ctx = graphql.WithResolverContext(ctx, &graphql.ResolverContext{
		Object: "Todo",
		Args:   nil,
		Field:  field,
	...
	return graphql.Defer(func() (ret graphql.Marshaler) {
		...
		resTmp, err := ec.ResolverMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
			return ec.resolvers.Todo_userRaw(ctx, obj)
		})
		if err != nil {
			ec.Error(ctx, err)
			return graphql.Null
...
func (ec *executionContext) _Todo_userLoader(ctx context.Context, field graphql.CollectedField, obj *Todo) graphql.Marshaler {
	ctx = graphql.WithResolverContext(ctx, &graphql.ResolverContext{
		Object: "Todo",
		Args:   nil,
		Field:  field,
	...
	return graphql.Defer(func() (ret graphql.Marshaler) {
		...
		resTmp, err := ec.ResolverMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
			return ec.resolvers.Todo_userLoader(ctx, obj)
		})
		if err != nil {
			ec.Error(ctx, err)
			return graphql.Null
